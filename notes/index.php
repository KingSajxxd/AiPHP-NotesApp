        ...
        <table class="table mt-5">
            ...
            <tbody>
                ...
                if(isset($_GET['search'])){
                    ...
                    if($search==''){
                        //All the records
                        $sql = "SELECT id,createdDate,title,description FROM notes WHERE email = '$email' ORDER BY createdDate DESC";
                    }
                    $sql = "SELECT id,createdDate,title,description FROM notes WHERE email = '$email' AND title LIKE '%$search%' ORDER BY createdDate DESC";
                }else{
